...
//调换舵机口顺序
code uchar changeOrder[21] = {0, 1, 2, 3, 4, 5, 6, 7,
                              20, 8, 9, 10, 11, 12, 13, 14,
                              15, 19, 18, 17, 16};

//21路PWM 定时值的高8位与低8位
static uchar timingValueH[24] = {0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5,
                                 0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5, 0xF5,
                                 0xF5, 0xF5, 0xF5, 0xF5, 0xF5,
                                 0xC6, 0xC6, 0xA6};
                                 
static uchar timingValueL[24] = {0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33,
